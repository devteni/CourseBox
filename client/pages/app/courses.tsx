...
import course, { fetchLecturerCourses, setCourses } from "../../slices/course/course";
        ...
        <div>
            ...
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    ...
                    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">DEPARTMENT OF {user.department.toUpperCase()}</h1>
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven&quot;t heard of them man bun deep jianbing selfies heirloom prism food truck ugh squid celiac humblebrag.</p>
                </div>
                <div className="flex flex-wrap justify-around">
                    {
                        courses.map((course, i) => {
                            return <div key={i+89089} className="relative xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-2 border-gray-200 border-opacity-60 cursor-pointer">
